...
<div class="bg-gray-100 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl font-bold text-gray-900">Contact Hotel<span class="text-amber-500">Az</span></h1>
            <p class="mt-4 text-lg text-gray-600">We'd love to hear from you. Reach out to us with any questions or inquiries.</p>
        </div>
    </div>
</div>
                ...
                <form method="POST" action="{{ route('contact.send') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="message" name="message" rows="5" required
                                  class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">{{ old('message') }}</textarea>
                    </div>
