...
<div class="bg-gray-50 py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 h-32 flex items-end p-6">
                <h1 class="text-2xl font-bold text-white">Welcome Back</h1>
            </div>
            
            <!-- Form Content -->
            <div class="p-6 sm:p-8">
                <p class="text-gray-600 mb-8">Sign in to access your reservations, exclusive offers, and personalized experience.</p>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}" required 
                                class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md placeholder-gray-400"
