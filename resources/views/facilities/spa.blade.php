    ...
    <div class="bg-lightest-green py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div>
                    <h2 class="text-3xl font-extrabold text-darkest-green">Wellness Sanctuary</h2>
                    ...
                    <div class="mt-8">
                        <h3 class="text-2xl font-bold text-darkest-green">Spa Facilities</h3>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-4 border-t border-b border-light-green py-4">
                            <div class="flex justify-between py-2">
                                <span class="text-dark-green">Monday - Sunday</span>
                                <span class="font-medium text-darkest-green">9:00 AM - 9:00 PM</span>
                            </div>
                            <div class="flex justify-between py-2">
                                <span class="text-dark-green">Last Appointment</span>
                                <span class="font-medium text-darkest-green">7:30 PM</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="bg-lightest-green p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-darkest-green mb-2">Indonesian Heritage Ritual</h3>
                    <p class="text-dark-green mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-medium-green font-medium">120 minutes</span>
                        <span class="text-medium-green font-medium">Rp 1,500,000</span>
                    </div>
                </div>
                
                <div class="bg-lightest-green p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-darkest-green mb-2">Royal Java Lulur</h3>
                    <p class="text-dark-green mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-medium-green font-medium">90 minutes</span>
                        <span class="text-medium-green font-medium">Rp 1,200,000</span>
                    </div>
                </div>
                
                <div class="bg-lightest-green p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-darkest-green mb-2">Stress Recovery Massage</h3>
                    <p class="text-dark-green mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-medium-green font-medium">60/90 minutes</span>
                        <span class="text-medium-green font-medium">Rp 850,000/1,100,000</span>
                    </div>
                </div>
                
                <div class="bg-lightest-green p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-darkest-green mb-2">Detoxifying Seaweed Wrap</h3>
                    <p class="text-dark-green mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-medium-green font-medium">75 minutes</span>
                        <span class="text-medium-green font-medium">Rp 950,000</span>
                    </div>
                </div>
                
                <div class="bg-lightest-green p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-darkest-green mb-2">Rejuvenating Facial</h3>
                    <p class="text-dark-green mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-medium-green font-medium">60 minutes</span>
                        <span class="text-medium-green font-medium">Rp 750,000</span>
                    </div>
                </div>
                
                <div class="bg-lightest-green p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-darkest-green mb-2">Couples Harmony</h3>
                    <p class="text-dark-green mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-medium-green font-medium">120 minutes</span>
                        <span class="text-medium-green font-medium">Rp 2,500,000</span>
                    </div>
                </div>
            </div>
            
            <div class="mt-12 text-center">
                <p class="text-dark-green mb-4">*All prices are subject to 21% government tax and service charge</p>
    ...
    <div class="bg-lightest-green py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-8 md:grid-cols-2">
                <div class="bg-light-green p-8 rounded-lg shadow-md">
                    <h3 class="text-2xl font-semibold text-darkest-green mb-4">Half-Day Escape</h3>
                    <p class="text-dark-green mb-6">
                    ...
                    <h4 class="text-lg font-medium text-medium-green mb-2">Includes:</h4>
                    <ul class="space-y-2 text-dark-green mb-6">
                        <li class="flex items-start">
                    ...
                    <div class="text-right">
                        <span class="text-2xl font-semibold text-medium-green">Rp 2,500,000</span>
                    </div>
                </div>
                
                <div class="bg-light-green p-8 rounded-lg shadow-md">
                    <h3 class="text-2xl font-semibold text-darkest-green mb-4">Full Wellness Journey</h3>
                    <p class="text-dark-green mb-6">
                    ...
                    <div class="text-right">
                        <span class="text-2xl font-semibold text-medium-green">Rp 4,500,000</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-medium-green">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 class="text-3xl font-extrabold tracking-tight text-lightest-green sm:text-4xl">
                ...
                <span class="block text-medium-green">Book your spa treatment today.</span>
            </h2>
            <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                <div class="inline-flex rounded-md shadow">
                    <a href="{{ route('contact') }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-medium-green bg-lightest-green hover:bg-light-green">
                        Contact Us
                    </a>
                </div>
            </div>
