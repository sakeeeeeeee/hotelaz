...
@section('content')
    ...
    <div class="bg-lightest-green py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div>
                    <h2 class="text-3xl font-extrabold text-darkest-green">Premium Fitness Experience</h2>
                    ...
                    <div class="mt-8">
                        <h3 class="text-2xl font-bold text-darkest-green">Fitness Center Features</h3>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-4 border-t border-b border-light-green py-4">
                            <div class="flex justify-between py-2">
                                <span class="text-dark-green">Monday - Friday</span>
                                <span class="font-medium text-darkest-green">6:00 AM - 10:00 PM</span>
                            </div>
                            <div class="flex justify-between py-2">
                                <span class="text-dark-green">Saturday - Sunday</span>
                                <span class="font-medium text-darkest-green">7:00 AM - 9:00 PM</span>
                            </div>
                            <div class="flex justify-between py-2">
                                <span class="text-dark-green">Hotel Guests Access</span>
                                <span class="font-medium text-darkest-green">24/7 with Room Key</span>
                            </div>
                        </div>
                        <p class="mt-4 text-sm text-dark-green">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="bg-lightest-green p-6 rounded-lg shadow-md text-center">
                    ...
                    <h3 class="text-lg font-medium text-darkest-green mb-2">Personal Training</h3>
                    <p class="text-dark-green">Our certified personal trainers are available for one-on-one sessions tailored to your fitness goals, whether you're looking to improve strength, endurance, or overall fitness.</p>
                    <p class="mt-4 text-medium-green font-medium">From Rp 500,000 per session</p>
                </div>
                ...
                <div class="bg-lightest-green p-6 rounded-lg shadow-md text-center">
                    ...
                    <h3 class="text-lg font-medium text-darkest-green mb-2">Group Fitness Classes</h3>
                    <p class="text-dark-green">Join our energizing group classes including yoga, pilates, HIIT, spinning, and more. Classes are designed for all fitness levels and are a great way to stay motivated.</p>
                    <p class="mt-4 text-medium-green font-medium">Complimentary for hotel guests</p>
                </div>
                ...
                <div class="bg-lightest-green p-6 rounded-lg shadow-md text-center">
                    ...
                    <h3 class="text-lg font-medium text-darkest-green mb-2">Fitness Assessment</h3>
                    <p class="text-dark-green">Start your fitness journey with a comprehensive assessment including body composition analysis, fitness testing, and goal setting with one of our professional trainers.</p>
                    <p class="mt-4 text-medium-green font-medium">Rp 350,000 per assessment</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-lightest-green py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 bg-lightest-green shadow overflow-hidden rounded-lg">
                <div class="px-4 py-5 sm:px-6 bg-medium-green text-lightest-green">
                    <h3 class="text-lg leading-6 font-medium">
                        This Week's Classes
                    </h3>
                    <p class="mt-1 max-w-2xl text-sm text-light-green">
                        All classes are 45-60 minutes. Please arrive 10 minutes early.
                    </p>
                </div>
                <div class="border-t border-light-green">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-light-green">
                            <thead class="bg-lightest-green">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-dark-green uppercase tracking-wider">
                                        Time
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-dark-green uppercase tracking-wider">
                                        Monday
                            ...
                            <tbody class="bg-lightest-green divide-y divide-light-green">
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-dark-green">
                                        7:00 AM
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-dark-green">
                                        Morning Yoga
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-dark-green">
                                        Pilates
    ...
    <div class="bg-medium-green">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 class="text-3xl font-extrabold tracking-tight text-lightest-green sm:text-4xl">
                ...
                <span class="block text-light-green">Book your stay with fitness center access included.</span>
            </h2>
            <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                <div class="inline-flex rounded-md shadow">
                    <a href="{{ route('rooms.index') }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-light-green bg-darkest-green hover:bg-light-green">
                        Book Now
                    </a>
                </div>
            </div>
